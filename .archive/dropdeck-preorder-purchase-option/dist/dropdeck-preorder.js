(() => {
  ...
  var getOneMonthAhead = () => {
    ...
    return oneMonthAhead.toISOString().split("T")[0];
  };
...
`;
  var createSPGroupVariables = (productIds, expectedFulfillmentDate, unitsPerCustomer) => ({
    variables: {
      input: {
        name: "Dropdeck Preorder",
        description: unitsPerCustomer === 0 ? `Expected to ship on or after ${parseISOStringIntoFormalDate(expectedFulfillmentDate)}` : `Expected to ship on or after ${parseISOStringIntoFormalDate(expectedFulfillmentDate)}, ${unitsPerCustomer} units per customer`,
...
`;
  var updateSPGroupVariables = (sellingPlanGroupId, sellingPlanId, expectedFulfillmentDate, unitsPerCustomer) => ({
    variables: {
...
`;
  ...
  function PurchaseOptionsActionExtension({ extension: extension2, context }) {
    ...
    const [intent, setIntent] = (0, import_react18.useState)("creating");
    const [isLoading, setIsLoading] = (0, import_react18.useState)(false);
    const [dateError, setDateError] = (0, import_react18.useState)(void 0);
    const [shopifyDomain, setShopifyDomain] = (0, import_react18.useState)(void 0);
    const [sellingPlanId, setSellingPlanId] = (0, import_react18.useState)(void 0);
    const [expectedFulfillmentDate, setExpectedFulfillmentDate] = (0, import_react18.useState)(getOneMonthAhead());
    const [unitsPerCustomer, setUnitsPerCustomer] = (0, import_react18.useState)(0);
    const [affectedProducts, setAffectedProducts] = (0, import_react18.useState)([]);
    ...
    (0, import_react18.useEffect)(() => {
      ...
      query(
        ...
        if (sellingPlanGroup) {
          ...
          setUnitsPerCustomer(Number((_a2 = sellingPlanGroup.sellingPlans.edges[0].node.metafields.edges.find((metafield) => metafield.node.key === "units_per_customer")) == null ? void 0 : _a2.node.value));
...
//# sourceMappingURL=dropdeck-preorder.js.map
